class Restaurant:
    def __init__(self, name, types):
        ...
        with open("C:/Python_Workspace/01_jump_to_python/5_APP/exer/고객서빙현황로그.txt", 'r', encoding='UTF-8') as customer_f:
            customer_log = ((customer_f.readlines())[-1])
    ...
    def __del__(self):
        ...
        with open("C:/Python_Workspace/01_jump_to_python/5_APP/exer/고객서빙현황로그.txt", 'a', encoding='UTF-8') as customer_f:
            customer_f.write("%d\n" % self.number_served)
