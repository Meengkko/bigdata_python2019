...
independent_variable_list = ['lotsize', 'bedrooms', 'bathrms', 'stories', 'driveway01', 'recroom01',
...
for num in range(1, 12):
    combi_list = list(combinations(independent_variable_list, num))
    for tup in combi_list:
        ...
        # print(lm.summary())
        independent_variable = house[list(tup)]
